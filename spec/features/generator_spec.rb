...
feature 'Foundation install succeeds' do
  scenario 'stylesheets assets files are added', :aggregate_failures do
  ...
  scenario 'javascripts assets files are added', :aggregate_failures do
  ...
  scenario 'layout file loads assets', :aggregate_failures do
